...
if("TRUE" STREQUAL "TRUE")
  set(styx_SOURCE_PREFIX /home/workspace/CarND-Capstone/ros/src/styx)
  set(styx_DEVEL_PREFIX /home/workspace/CarND-Capstone/ros/devel)
  set(styx_INSTALL_PREFIX "")
  set(styx_PREFIX ${styx_DEVEL_PREFIX})
else()
  set(styx_SOURCE_PREFIX "")
  set(styx_DEVEL_PREFIX "")
  set(styx_INSTALL_PREFIX /home/workspace/CarND-Capstone/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'styx' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace/CarND-Capstone/ros/src/styx/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT styx_NUM_DUMMY_TARGETS)
      set(styx_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::styx::wrapped-linker-option${styx_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR styx_NUM_DUMMY_TARGETS "${styx_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::styx::wrapped-linker-option${styx_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND styx_LIBRARIES "${interface_target_name}")
