...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_updater_SOURCE_PREFIX /home/workspace/CarND-Capstone/ros/src/waypoint_updater)
  set(waypoint_updater_DEVEL_PREFIX /home/workspace/CarND-Capstone/ros/devel)
  ...
  set(waypoint_updater_INSTALL_PREFIX /home/workspace/CarND-Capstone/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace/CarND-Capstone/ros/src/waypoint_updater/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT waypoint_updater_NUM_DUMMY_TARGETS)
      set(waypoint_updater_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::waypoint_updater::wrapped-linker-option${waypoint_updater_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR waypoint_updater_NUM_DUMMY_TARGETS "${waypoint_updater_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::waypoint_updater::wrapped-linker-option${waypoint_updater_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND waypoint_updater_LIBRARIES "${interface_target_name}")
