...
if("TRUE" STREQUAL "TRUE")
  set(tl_detector_SOURCE_PREFIX /home/workspace/CarND-Capstone/ros/src/tl_detector)
  set(tl_detector_DEVEL_PREFIX /home/workspace/CarND-Capstone/ros/devel)
  ...
  set(tl_detector_INSTALL_PREFIX /home/workspace/CarND-Capstone/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tl_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace/CarND-Capstone/ros/src/tl_detector/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT tl_detector_NUM_DUMMY_TARGETS)
      set(tl_detector_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::tl_detector::wrapped-linker-option${tl_detector_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR tl_detector_NUM_DUMMY_TARGETS "${tl_detector_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::tl_detector::wrapped-linker-option${tl_detector_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND tl_detector_LIBRARIES "${interface_target_name}")
