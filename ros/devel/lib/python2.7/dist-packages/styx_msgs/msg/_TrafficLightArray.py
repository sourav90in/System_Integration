...
"""autogenerated by genpy from styx_msgs/TrafficLightArray.msg. Do not edit."""
import sys
...
class TrafficLightArray(genpy.Message):
  _md5sum = "fea87549a0db156d6ca9e4e197c34cb2"
  _type = "styx_msgs/TrafficLightArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','styx_msgs/TrafficLight[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = styx_msgs.msg.TrafficLight()
        _v9 = val1.header
        start = end
        end += 4
